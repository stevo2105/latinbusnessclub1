            ...
            if ( $('body' ).hasClass('inverse') || $('body' ).hasClass('color_bg') || $('body' ).hasClass('gradient_bg') ) {
                initDaysLeft(
                    dayBlocks, {
                        ...
                        textFont   : '18px Abel',
                        data       : "December 04, 2015", // YOUR DATA
                        text       : 'DAYS LEFT', // text
                        lineColor  : 'rgba(0,0,0,0.5)'
                    }
                );
...
( function () {
    $( '.subscribe-btn' ).on(
        'click', function ( e ) {
            ...
            document.forms[ 'subscribe-form' ][ 'subscribe' ].placeholder = 'john@something.com';
...
$(document ).ready(function(){
    ...
    $('.notify-me').submit(function(e){
        ...
        var element = document.getElementById('text-field');
        ...
        if (element.value.indexOf('@') === -1) {
			...
			document.getElementById('max-hidden-form').value=maxPrice;
			document.getElementById('hidden-formm').submit();
			
        } else {

            email = element.value;
			document.getElementById('email-hidden-form').value=email;


        }
        document.getElementById('helper-text').innerHTML = "Enter Max Price:";

        element.placeholder = "$0.00";


        document.getElementById('text-field').setAttribute("type", "text");
		document.getElementById('switcher').value="onprice";
      //  document.getElementById('text-field').setAttribute("onkeyup", "formatNum(this)");
        element.value = "";
